...
public class TestInventory : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        InventoryManager.Instance.GetSelectedSlot();            // 获取当前选中的物品栏
        InventoryManager.Instance.GetSlots();                   // 获取所有物品栏
        InventoryManager.Instance.ChangeSelectedSlot(0, InventoryManager.Instance.GetSlots()[0]);  // 更改选中的物品栏
        InventoryManager.Instance.ChangeSelectedSlot(1, InventoryManager.Instance.GetSlots()[1]);  // 更改选中的物品栏
        InventoryManager.Instance.UseSelectedSlotItem();    // 使用选中的物品（直接在游戏里按 E 也可以）
